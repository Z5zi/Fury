#!/usr/bin/env python3
"""Generate soft-path P0 crops + Cycle-9 mini contact sheet (≤4 tiles) for low-upload ChatGPT."""
...
def main():
    ...
    draw.text((10, 10), "Vaultline AAA Meridian Mutual — Cycle-9 MINI (Harbor Metro / HMPD)", fill=(230, 230, 235))
    ...
    out = ROOT / "sheet_cycle9_mini.jpg"
